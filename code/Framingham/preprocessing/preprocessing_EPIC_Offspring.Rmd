...
# (days dementia occured since exam 1  - days since exam 1)/365
...
pheno_df <- pheno_df %>% 
  mutate(
    ...
    dem_ad_status_before_visit = case_when(
      ...
      # Dementia or AD status established (=1) and follow up years < 0 code as 1
      (pheno_df$DEM_STATUS == 1|pheno_df$AD_STATUS == 1) & 
        pheno_df$dem_followup_time <= 0 ~ 1 , 
